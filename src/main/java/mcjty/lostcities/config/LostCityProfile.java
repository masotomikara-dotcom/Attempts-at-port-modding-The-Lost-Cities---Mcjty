...
public class LostCityProfile implements ILostCityProfile {
    ...
    public ResourceLocation getIcon() {
        ...
        icon = new net.minecraft.resources.ResourceLocation(mcjty.lostcities.LostCities.MODID, iconFile);
        return icon;
    }
    ...
    public BlockState getLiquidBlock() {
        if (liquidBlock == null) {
            Block b = net.minecraft.core.registries.net.minecraft.core.registries.net.minecraft.core.registries.net.minecraft.core.registries.BuiltInRegistries.BLOCK.get(new net.minecraft.resources.ResourceLocation(LIQUID_BLOCK));
            if (b == null) {
    ...
    public BlockState getBaseBlock() {
        if (baseBlock == null) {
            Block b = net.minecraft.core.registries.net.minecraft.core.registries.net.minecraft.core.registries.net.minecraft.core.registries.BuiltInRegistries.BLOCK.get(new net.minecraft.resources.ResourceLocation(BASE_BLOCK));
            if (b == null) {
