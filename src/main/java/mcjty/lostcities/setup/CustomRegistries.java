...
public class CustomRegistries {
    ...
    public static final net.minecraftforge.registries.FabricDeferredRegister BUILDING_DEFERRED_REGISTER = net.minecraftforge.registries.FabricDeferredRegister.create(null, "lostcities");
    ...
    public static final net.minecraftforge.registries.FabricDeferredRegister PALETTE_DEFERRED_REGISTER = net.minecraftforge.registries.FabricDeferredRegister.create(null, "lostcities");
    ...
    public static final net.minecraftforge.registries.FabricDeferredRegister PART_DEFERRED_REGISTER = net.minecraftforge.registries.FabricDeferredRegister.create(null, "lostcities");
    ...
    public static final net.minecraftforge.registries.FabricDeferredRegister STYLE_DEFERRED_REGISTER = net.minecraftforge.registries.FabricDeferredRegister.create(null, "lostcities");
    ...
    public static final net.minecraftforge.registries.FabricDeferredRegister CONDITIONS_DEFERRED_REGISTER = net.minecraftforge.registries.FabricDeferredRegister.create(null, "lostcities");
    ...
    public static final net.minecraftforge.registries.FabricDeferredRegister CITYSTYLES_DEFERRED_REGISTER = net.minecraftforge.registries.FabricDeferredRegister.create(null, "lostcities");
    ...
    public static final net.minecraftforge.registries.FabricDeferredRegister MULTIBUILDINGS_DEFERRED_REGISTER = net.minecraftforge.registries.FabricDeferredRegister.create(null, "lostcities");
    ...
    public static final net.minecraftforge.registries.FabricDeferredRegister VARIANTS_DEFERRED_REGISTER = net.minecraftforge.registries.FabricDeferredRegister.create(null, "lostcities");
    ...
    public static final net.minecraftforge.registries.FabricDeferredRegister WORLDSTYLES_DEFERRED_REGISTER = net.minecraftforge.registries.FabricDeferredRegister.create(null, "lostcities");
    ...
    public static final net.minecraftforge.registries.FabricDeferredRegister PREDEFINEDCITIES_DEFERRED_REGISTER = net.minecraftforge.registries.FabricDeferredRegister.create(null, "lostcities");
    ...
    public static final net.minecraftforge.registries.FabricDeferredRegister PREDEFINEDSPHERES_DEFERRED_REGISTER = net.minecraftforge.registries.FabricDeferredRegister.create(null, "lostcities");
    ...
    public static final net.minecraftforge.registries.FabricDeferredRegister SCATTERED_DEFERRED_REGISTER = net.minecraftforge.registries.FabricDeferredRegister.create(null, "lostcities");
