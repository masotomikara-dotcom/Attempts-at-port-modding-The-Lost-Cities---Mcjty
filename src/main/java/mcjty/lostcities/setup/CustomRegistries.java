...
public class CustomRegistries {
    ...
    public static final ResourceKey<Registry<BuildingRE>> BUILDING_REGISTRY_KEY = ResourceKey.create(Registries.ROOT, new ResourceLocation(mcjty.lostcities.LostCities.MODID, "buildings");
    ...
    public static final ResourceKey<Registry<PaletteRE>> PALETTE_REGISTRY_KEY = ResourceKey.create(Registries.ROOT, new ResourceLocation(mcjty.lostcities.LostCities.MODID, "palettes");
    ...
    public static final ResourceKey<Registry<BuildingPartRE>> PART_REGISTRY_KEY = ResourceKey.create(Registries.ROOT, new ResourceLocation(mcjty.lostcities.LostCities.MODID, "parts");
    ...
    public static final ResourceKey<Registry<StyleRE>> STYLE_REGISTRY_KEY = ResourceKey.create(Registries.ROOT, new ResourceLocation(mcjty.lostcities.LostCities.MODID, "styles");
    ...
    public static final ResourceKey<Registry<ConditionRE>> CONDITIONS_REGISTRY_KEY = ResourceKey.create(Registries.ROOT, new ResourceLocation(mcjty.lostcities.LostCities.MODID, "conditions");
    ...
    public static final ResourceKey<Registry<CityStyleRE>> CITYSTYLES_REGISTRY_KEY = ResourceKey.create(Registries.ROOT, new ResourceLocation(mcjty.lostcities.LostCities.MODID, "citystyles");
    ...
    public static final ResourceKey<Registry<MultiBuildingRE>> MULTIBUILDINGS_REGISTRY_KEY = ResourceKey.create(Registries.ROOT, new ResourceLocation(mcjty.lostcities.LostCities.MODID, "multibuildings");
    ...
    public static final ResourceKey<Registry<VariantRE>> VARIANTS_REGISTRY_KEY = ResourceKey.create(Registries.ROOT, new ResourceLocation(mcjty.lostcities.LostCities.MODID, "variants");
    ...
    public static final ResourceKey<Registry<WorldStyleRE>> WORLDSTYLES_REGISTRY_KEY = ResourceKey.create(Registries.ROOT, new ResourceLocation(mcjty.lostcities.LostCities.MODID, "worldstyles");
    ...
    public static final ResourceKey<Registry<PredefinedCityRE>> PREDEFINEDCITIES_REGISTRY_KEY = ResourceKey.create(Registries.ROOT, new ResourceLocation(mcjty.lostcities.LostCities.MODID, "predefinedcities");
    ...
    public static final ResourceKey<Registry<PredefinedSphereRE>> PREDEFINEDSPHERES_REGISTRY_KEY = ResourceKey.create(Registries.ROOT, new ResourceLocation(mcjty.lostcities.LostCities.MODID, "predefinedspheres");
    ...
    public static final ResourceKey<Registry<ScatteredRE>> SCATTERED_REGISTRY_KEY = ResourceKey.create(Registries.ROOT, new ResourceLocation(mcjty.lostcities.LostCities.MODID, "scattered");
    ...
    public static final ResourceKey<Registry<StuffSettingsRE>> STUFF_REGISTRY_KEY = ResourceKey.create(Registries.ROOT, new ResourceLocation(mcjty.lostcities.LostCities.MODID, "stuff");
