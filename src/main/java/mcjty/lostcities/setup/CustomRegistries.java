...
public class CustomRegistries {
    ...
    public static final net.minecraftforge.registries.DeferredRegister<BuildingRE> BUILDING_DEFERRED_REGISTER = net.minecraftforge.registries.DeferredRegister.create(null, "lostcities");
    ...
    public static final net.minecraftforge.registries.DeferredRegister<PaletteRE> PALETTE_DEFERRED_REGISTER = net.minecraftforge.registries.DeferredRegister.create(null, "lostcities");
    ...
    public static final net.minecraftforge.registries.DeferredRegister<BuildingPartRE> PART_DEFERRED_REGISTER = net.minecraftforge.registries.DeferredRegister.create(null, "lostcities");
    ...
    public static final net.minecraftforge.registries.DeferredRegister<StyleRE> STYLE_DEFERRED_REGISTER = net.minecraftforge.registries.DeferredRegister.create(null, "lostcities");
    ...
    public static final net.minecraftforge.registries.DeferredRegister<ConditionRE> CONDITIONS_DEFERRED_REGISTER = net.minecraftforge.registries.DeferredRegister.create(null, "lostcities");
    ...
    public static final net.minecraftforge.registries.DeferredRegister<CityStyleRE> CITYSTYLES_DEFERRED_REGISTER = net.minecraftforge.registries.DeferredRegister.create(null, "lostcities");
    ...
    public static final net.minecraftforge.registries.DeferredRegister<MultiBuildingRE> MULTIBUILDINGS_DEFERRED_REGISTER = net.minecraftforge.registries.DeferredRegister.create(null, "lostcities");
    ...
    public static final net.minecraftforge.registries.DeferredRegister<VariantRE> VARIANTS_DEFERRED_REGISTER = net.minecraftforge.registries.DeferredRegister.create(null, "lostcities");
    ...
    public static final net.minecraftforge.registries.DeferredRegister<WorldStyleRE> WORLDSTYLES_DEFERRED_REGISTER = net.minecraftforge.registries.DeferredRegister.create(null, "lostcities");
    ...
    public static final net.minecraftforge.registries.DeferredRegister<PredefinedCityRE> PREDEFINEDCITIES_DEFERRED_REGISTER = net.minecraftforge.registries.DeferredRegister.create(null, "lostcities");
    ...
    public static final net.minecraftforge.registries.DeferredRegister<PredefinedSphereRE> PREDEFINEDSPHERES_DEFERRED_REGISTER = net.minecraftforge.registries.DeferredRegister.create(null, "lostcities");
    ...
    public static final net.minecraftforge.registries.DeferredRegister<ScatteredRE> SCATTERED_DEFERRED_REGISTER = net.minecraftforge.registries.DeferredRegister.create(null, "lostcities");
    ...
    public static final net.minecraftforge.registries.DeferredRegister<StuffSettingsRE> STUFF_DEFERRED_REGISTER = net.minecraftforge.registries.DeferredRegister.create(null, "lostcities");
