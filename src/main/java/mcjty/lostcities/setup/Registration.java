...
public class Registration {
    ...
    public static final DeferredRegister<Feature<?>> FEATURES = DeferredRegister.create(Registries.FEATURE, mcjty.lostcities.LostCities.MODID);
    ...
    public static final ResourceLocation LOSTCITY = new net.minecraft.resources.ResourceLocation(mcjty.lostcities.LostCities.MODID, "lostcity");
