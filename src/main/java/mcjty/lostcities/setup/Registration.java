...
public class Registration {
    ...
    public static final ResourceLocation LOSTCITY = new net.minecraft.resources.ResourceLocation(mcjty.lostcities.mcjty.lostcities.LostCities.MODID, "lostcity");
